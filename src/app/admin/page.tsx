      ...
      <div className='mt-3 flex flex-row gap-4'>
        <div className="rounded-2xl border border-blue-100 bg-white p-4 shadow-lg sm:p-6 lg:p-8" role="alert">
          <div className="flex items-center gap-4">
            ...
            <p className="font-medium sm:text-lg">Total message!</p>
          </div>

          <p className="mt-4 text-gray-500">
          Client messaging plays a crucial role in establishing effective communication between businesses and their customers. Whether it is through emails, text messages, or in-app notifications, these messages serve as a direct channel for delivering important updates, promotions, and personalized information. 
          </p>
        ...
        <div className="rounded-2xl border border-blue-100 bg-white p-4 shadow-lg sm:p-6 lg:p-8" role="alert">
          <div className="flex items-center gap-4">
            ...
            <p className="font-medium sm:text-lg">Client Call!</p>
          </div>

          <p className="mt-4 text-gray-500">
          
Client calls are pivotal moments in establishing and maintaining strong relationships between businesses and their customers. These interactions provide a direct and personalized connection, allowing for effective communication, issue resolution, and relationship building. 
          </p>
